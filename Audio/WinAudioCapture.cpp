...
//Multimedia class scheduler...whatever that is and does
...
WinAudioCapture::WinAudioCapture(IMMDevice *Endpoint, bool EnableStreamSwitch, ERole EndpointRole) :
_RefCount(1),
_Endpoint(Endpoint),
_AudioClient(NULL),
_CaptureClient(NULL),
...
//
WinAudioCapture::~WinAudioCapture(void)
{
}
...
//
bool WinAudioCapture::InitializeAudioEngine()
{
...
//
bool WinAudioCapture::LoadFormat()
{
...
//
bool WinAudioCapture::Initialize(UINT32 EngineLatency)
{
	//
...
//  Start capturing...
//
bool WinAudioCapture::Start(BYTE *CaptureBuffer, size_t CaptureBufferSize)
{
	HRESULT hr;
...
//
DWORD WinAudioCapture::WASAPICaptureThread(LPVOID Context)
{
	WinAudioCapture *capturer = static_cast<WinAudioCapture *>(Context);
	return capturer->DoCaptureThread();
}

DWORD WinAudioCapture::DoCaptureThread()
{
...
//
bool WinAudioCapture::InitializeStreamSwitch()
{
...
void WinAudioCapture::TerminateStreamSwitch()
{
...
//
bool WinAudioCapture::HandleStreamSwitchEvent()
{
	HRESULT hr;
...
//
HRESULT WinAudioCapture::OnSessionDisconnected(AudioSessionDisconnectReason DisconnectReason)
{
...
//
HRESULT WinAudioCapture::OnDefaultDeviceChanged(EDataFlow Flow, ERole Role, LPCWSTR /*NewDefaultDeviceId*/)
{
...
//  IUnknown
//
HRESULT WinAudioCapture::QueryInterface(REFIID Iid, void **Object)
{
	if (Object == NULL)
	{
		return E_POINTER;
...
ULONG WinAudioCapture::AddRef()
{
	return InterlockedIncrement(&_RefCount);
}
ULONG WinAudioCapture::Release()
{
